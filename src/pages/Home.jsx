...
function Home(){
    ...
    return (
        ...
        <div className="relative w-screen h-screen bg-cover bg-center pt-20"  style={{ backgroundImage: `url(${bg})`  }}>
            ...
            <div className="absolute animate-fade-up duration-3000 mx-auto text-start px-20 py-24 mt-20 left-0 right-0 lg:w-[1300px] w-1000px flex border gap-x-60 justify-center items-end rounded-xl border-white/80">
