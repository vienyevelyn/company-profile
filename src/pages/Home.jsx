...
function Home(){
    ...
    return (
        ...
        <div className="relative w-screen h-screen bg-cover bg-center pt-20"  style={{ backgroundImage: `url(${bg})`  }}>
            ...
            <div className="absolute mx-auto text-start px-20 py-24 mt-20 left-0 right-0 w-[1300px] flex border gap-x-60 justify-center items-end rounded-xl border-white/80">
                <div className="shrink-0">
                    <h1 className="text-7xl font-bold text-white">World's</h1>
                    <h1 className="text-5xl font-bold text-white/70">One and Only</h1>
                    <h1 className="text-7xl font-bold text-white">Finest AI</h1>
                </div>
                <div className="text-end">
                    ...
                    <button><Link to={"/about"} className="bg-blue-800 py-2 px-3 rounded-full text-white">About Us</Link></button>
                </div>
            </div>
